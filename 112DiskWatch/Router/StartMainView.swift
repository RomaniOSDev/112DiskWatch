...
struct CompletionPulseBadge: View {
...
struct GateSplashScreen: View {
    private static let captionBytes: [UInt8] = [0x0B, 0x28, 0x26, 0x23, 0x2E, 0x29, 0x20, 0x69, 0x69, 0x69]
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                DualArcSpinner(progress: 0)

                Text(RouteLiteralDecoder.reveal(Self.captionBytes))
